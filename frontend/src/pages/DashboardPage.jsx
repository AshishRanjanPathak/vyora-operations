...
export const DashboardPage = () => {
  ...
  return (
    <div className="space-y-8">
      {/* 1. FEATURED VARIANT: Operations Hero Banner */}
      ...
      {/* 2. COMPACT VARIANT: Fast Operational Summary Strips */}
      ...
      {/* 3. KPI & ALERT VARIANTS: Metrics Grid */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {kpis.map((kpi, idx) => (
          <Link key={idx} to={kpi.href} className="block group">
            <Card variant={kpi.variant} className="h-full flex flex-col justify-between">
      ...
      {/* 4. DEFAULT VARIANT: Fulfillment Progress & Velocity */}
      ...
      {/* 5. DEFAULT VARIANT: Recent Dispatches Ledger */}
      <Card variant="default">
